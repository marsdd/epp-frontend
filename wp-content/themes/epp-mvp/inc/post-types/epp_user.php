<?php
// Create EPP User custom post type
function register_epp_user_post_type()
{
  $custom_post_type = 'epp_user';// Name of post type
  $upp_plural_name = 'EPP Users';// Post type uppercase plural name
  $upp_singular_name = 'EPP User';// Post type uppercase singular name
  $low_plural_name = 'EPP users';// Post type lowercase plural name
...
add_action('init', 'register_epp_user_post_type');